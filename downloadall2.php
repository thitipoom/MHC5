...
$query = "SELECT * FROM ecdoc_documents WHERE topic = ' .$row['topic'] .  ' ORDER by id DESC LIMIT 30" or die("Error:" . mysqli_error()); 
...
//หัวข้อตาราง
echo "<tr align='center' bgcolor='#83C7E9'><td>ชื่อโครงการ</td><td>วันที่</td><td>ดาวน์โหลด</td></tr>";
