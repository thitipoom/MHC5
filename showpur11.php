...
$query = "SELECT * FROM ecdoc_documents WHERE categorie_id = 11 ORDER by id DESC LIMIT 10" or die("Error:" . mysqli_error()); 
...
echo "</table>";
echo "<td><a target =_blank' href='pagepur11all.php' class='btn btn-info'>ดูทั้งหมด</a></td> ";
//5. close connection
mysqli_close($con);
?>
